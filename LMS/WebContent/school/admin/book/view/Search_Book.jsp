                ...
                <div class="content-wrap">
                    ...
                    <div class="col-lg-6">
							...
							<div class="col-lg-6">
                                            ...
                                            <section class="panel">
                                                <header class="panel-heading">Search ISBN</header>
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/search-bar-code/" class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">ISBN </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="search" id="bar" data-parsley-required="true" data-parsley-trigger="change" placeholder="Search ISBN">
                                                               </div> 
                                                     ...
                                                     <hr> 
                                                        ...
                                                        <div class="form-group">    
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                <button type="submit" class="btn btn-default">Search ISBN</button>
                                                            </div>
                                                        </div>
                                                    </form>
